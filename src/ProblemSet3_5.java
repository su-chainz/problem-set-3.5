...
public class ProblemSet3_5 {
	...
	public void leapYears(int count) {
		if (count <= 0) {
			...
			for (int i = 0; i < (count * 4); i += 4) {
				if(isLeap(2020 + i) == true) {
					if (i < (count * 4 - 4)) {
						System.out.print((2020 + i) + ", ");
					} else {
						System.out.println("and " + (2020 + i) + ".");
					}
				} else if (isLeap(2020 + i) != true) {
					count = count + 1;
				}
			}
		}
	...
	public void fibonacci(int n) {
		long fibonacci = fib(n+1);
		if (((n % 10 == 1) || (n % 10 == 2) || (n % 10 == 3)) && ((n != 11) && (n != 12) && (n != 13))) {
			if (n % 10 == 1) {
				System.out.println("The " +n+"st fibonacci number is " + fibonacci + ".");
			} else if (n % 10 == 2) {
				System.out.println("The " +n+"nd fibonacci number is " + fibonacci + ".");
			} else if (n % 10 == 2) {
				System.out.println("The " +n+"rd fibonacci number is " + fibonacci + ".");
			} 
		} else {
